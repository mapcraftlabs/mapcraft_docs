...
Geocsv is a standard csv file where one of the columns is titled "geometry".  This column should contain either a WKT or geojson geometry column (WKT is recommended) in lat-lng (other projections are not supported).
